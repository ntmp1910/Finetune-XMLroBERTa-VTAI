...
def main():
    ...
    # Khởi tạo predictor - Use the imported class
    predictor = VietnameseTextClassifier(model_name=args.model_path) # Use VietnameseTextClassifier
    predictor.setup_model() # Load tokenizer and model
    #predictor.load_model() # No longer needed
    ...
    #if args.with_confidence: # Removed confidence option for simplicity
